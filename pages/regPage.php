...
<div class="login-form-container">
    ...
    <div class="container">
        <div id="close-login-btn" class="fas fa-times"></div>
            ...
            <a href="regPage.php?logout=<?php echo $user_id; ?>" class="delete-btn">logout</a>
            <p>new <a href="regPagelogin.php" class="linklog">login</a> or <a href="Jseeker_Reg.php" class="linkreg">register</a></p>
            </div>
