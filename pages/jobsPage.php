...
<div class="login-form-container">
    ...
    <div class="container">
        <div id="close-login-btn" class="fas fa-times"></div>
            ...
            <a href="jobsPage.php?logout=<?php echo $user_id; ?>" class="delete-btn">logout</a>
            <p>new <a href="jobspagelogin.php" class="linklog">login</a> or <a href="Jseeker_Reg.php" class="linkreg">register</a></p>
            </div>
