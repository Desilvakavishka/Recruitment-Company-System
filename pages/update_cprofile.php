...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($conn, "UPDATE `client_registration` SET c_username = '$update_name', c_Email = '$update_email' WHERE ID = '$client_id'") or die('query failed');
   ...
   if(!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass)){
      if($update_pass != $old_pass){
         ...
         mysqli_query($conn, "UPDATE `client_registration` SET c_pw = '$confirm_pass' WHERE ID = '$client_id'") or die('query failed');
   ...
   if(!empty($update_image)){
      if($update_image_size > 2000000){
         ...
         $image_update_query = mysqli_query($conn, "UPDATE `client_registration` SET c_img = '$update_image' WHERE ID = '$client_id'") or die('query failed');
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <div class="flex">
      <div class="inputBox">
         <span>username :</span>
         <input type="text" name="update_name" value="<?php echo $fetch['c_username']; ?>" class="box">
      ...
      <div class="inputBox">
         <input type="hidden" name="old_pass" value="<?php echo $fetch['c_pw']; ?>">
   ...
   <a href="cindexlog.php" class="delete-btn">go back</a>
</form>
